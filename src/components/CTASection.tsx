      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground mb-10">
            Get the best price for your scrap. Contact us today for a free quote and fast pickup service.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {[
              { icon: Phone, label: "Call Us", value: "+1 (234) 567-890" },
              { icon: MapPin, label: "Location", value: "Industrial Area, City" },
              ...
              >
                ...
                <span className="font-heading text-sm uppercase tracking-wider text-muted-foreground mb-1">
                  {info.label}
                </span>
